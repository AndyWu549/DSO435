...
Intake_Form_ID constraint Intake_PreIntake_FK references Intake_Form,
preIntake_Date Date not null);

Create Table Applicant_Income_Relation(
Form_ID number(6) constraint Person_Income_FK references Intake_Form,
Income_ID Number(10) constraint Income_Income_FK references Income_source,
Constraint Applicant_Income_Relation_PK primary Key (Form_ID, Income_ID));
...
Form_ID number(6) constraint Gov_Intake_FK references Intake_Form,
Constraint Applicant_Gov_Relation_Pk Primary Key(Assistance_ID,Form_ID));
...
Form_ID number(6) constraint Pets_Intake_FK references Intake_form,
...
Form_ID number(6) constraint Referral_Intake_Fk references Intake_Form,
Referral_num number(5) constraint Referral_Referral_Fk references Referral,
constraint Referral_Applicant_Pk primary key( Form_ID, Referral_num));
...
CREATE INDEX Pet_Intake_FK ON PETS(Form_ID);
...
CREATE INDEX Intake_BrackID_FK ON Intake_Form(BracketID);
CREATE INDEX Intake_Religion_ID_FK ON Intake_Form(Religion_ID);
CREATE INDEX Intake_Area_ID_FK ON Intake_Form(Area_ID);
CREATE INDEX Intake_Area_Other_ID_FK ON Intake_Form(Area_Other_ID);
CREATE INDEX Intake_Living_Status_ID_FK ON Intake_Form(Living_Status_ID);
...
CREATE INDEX preIntake_spouse on PreIntake(Spouse_ID);
CREATE INDEX preIntake_location on PreIntake(Location_ID);
CREATE INDEX Referal_Intake ON Referral_Applicant(Form_ID);
...
Insert into Applicant values(1,'Mobile','(321)331-4491','changhao@usc.edu','11-05-2000','Y','Y',null,'4 months');
Insert into Applicant values(2,'Mobile','(213)740-2311','LilyTa007@Gamil.com','10-21-2001','N','Y',333444222,'3 months');
Insert into Applicant values(3,'Land Line','(213)841-3422','RyannaLui444@gmail.com','06-22-2002','Y','N',null,'4 months');
Insert into Applicant values(7,'Mobile','(213)349-5172','DennyGray@gmail.com','03-12-1988','Y','N',null,'4 months');
...
Insert into Applicant_income_relation values(3,1);
Insert into Applicant_income_relation values(4,3);
Insert into Applicant_income_relation values(5,3);
...
Insert into Intake_form values(1, '12-06-2023', '08-22-2023','Y','Y','Y','N','Unemployeement','No Job','Y','2022','Y','Y','N','N','Y','N','Y',1,2,1,4,1,2,1,null,1,null,1);
Insert into Intake_form Values(2, '10-15-2023','09-03-2023','Y','N','N','Y','Disability','Can not find a job','N','2023','N','Y','N','N','N','N','Y',2,1,3,null,2,1,2,1,2,null,2);
Insert into Intake_form Values(3, '11-20-2023','09-03-2023','Y','N','N','Y','Disability','Not enough government assistance','N','2023','N','Y','N','N','N','N','Y',2,1,3,null,2,1,2,1,2,null,2);
Insert into Intake_form Values(4, '9-17-2023','08-03-2023','N','Y','N','N', 'Unemployeement','Recession', 'Y','2021','Y','Y','N','N','Y','Y','Y',3,2,3,null,3,3,3,2,null,1,2);
Insert into Intake_form Values(5, '12-07-2023','08-03-2023','N','Y','N','N', 'Jobless','Unable to have a income', 'Y','2021','Y','Y','N','N','Y','Y','Y',3,2,3,null,7,3,3,2,null,1,2);
...
Insert into Referral_Applicant values(4,1);
Insert into Referral_Applicant values(2,1);
Insert into Referral_Applicant values(1,2);
Insert into Referral_Applicant values(3,2);
...
select First_Name,Last_Name,count(pets.pet_size_id) as Number_Of_Large_Pets
...
from People,Applicant,preIntake
where people.person_id = applicant.person_ID
and preIntake.Applicant_ID = applicant.person_ID
